...
public class BrowserContent extends StackPane {
    ...
    private void registerBack(Pane content) {
        Set<BackButton> buttons = Util.lookupAll(content, BackButton.class);
    ...
    private void registerForward(Pane content) {
        Set<ForwardButton> buttons = Util.lookupAll(content, ForwardButton.class);
        if (buttons.isEmpty()) return;
    ...
    private void regsiterAddress(Pane content) {
        Set<AddressBar> addrs = Util.lookupAll(content, AddressBar.class);
