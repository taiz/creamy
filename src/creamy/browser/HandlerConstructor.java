...
class HandlerConstructor {
    ...
    private void constructSubmitHandler(Node root) {
        Set<CFSubmitButton> buttons = Util.lookupAll(root, CFSubmitButton.class);
    ...
    private void constructLinkHandler(Node root) {
        ...
        controls.addAll(Util.lookupAll(root, CFHyperlink.class));
        controls.addAll(Util.lookupAll(root, CFLinkButton.class));
