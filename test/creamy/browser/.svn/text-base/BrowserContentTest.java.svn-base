...
public class BrowserContentTest {
    ...
    public void testGetElementsByClass() {
        ...
        // Assertion
        assertEquals(backButton, (Util.lookup(content, DefaultBackButton.class)));
        assertEquals(forwardButton, (Util.lookup(content, DefaultForwardButton.class)));
        assertEquals(addressBar, (Util.lookup(content, AddressBar.class)));
        List<Button> list = new ArrayList<Button>();
        list.add(button);
        list.add(backButton);
        list.add(forwardButton);
        Set<Button> result = Util.lookupAll(content, Button.class);
