...
public class UtilTest {
    ...
    public void testLookup() {
        ...
        HBox root = HBoxBuilder.create()
                ...
                .build();
        // Assertion
        Button res = Util.lookup(root, Button.class);
    ...
    public void testLookupAll() {
        ...
        HBox root = HBoxBuilder.create()
                ...
                .build();
        // Assertion
        Set<Button> buttons = Util.lookupAll(root, Button.class);
    ...
    public void testLookupAllInTableView() {
        ...
        table.setItems(data);
        // Assertion
        Set<Button> result = Util.lookupAllInTableView(table, Button.class);
